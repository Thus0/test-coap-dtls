...
#define BIND_PORT "5684"
#define BIND_NAME "localhost"
...
int main( void )
{
     ...
     */
    printf( "  . Bind on udp/*/%s ...", BIND_PORT );
    fflush( stdout );

    if( ( ret = mbedtls_net_bind( &listen_fd, BIND_IP, BIND_PORT, MBEDTLS_NET_PROTO_UDP ) ) != 0 )
    {
