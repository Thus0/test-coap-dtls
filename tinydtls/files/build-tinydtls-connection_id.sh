...
#
#        author: Thus0
# last modified: 2022-02-07 23:38
...
cd /app || exit 1
git clone -b feature/connection_id --single-branch --depth 1 \
	https://github.com/eclipse/tinydtls.git tinydtls-connection_id || exit 2

# Build and install tinydtls library and demos
cd /app/tinydtls-connection_id || exit 1
./autogen.sh
./configure
make
make install
