...
public class CredentialsUtil {
	 ...
	 */
	public static final List<Mode> DEFAULT_CLIENT_MODES = Arrays.asList(Mode.RPK);
	 ...
	 */
	public static final List<Mode> DEFAULT_SERVER_MODES = Arrays.asList(Mode.RPK, Mode.X509);
